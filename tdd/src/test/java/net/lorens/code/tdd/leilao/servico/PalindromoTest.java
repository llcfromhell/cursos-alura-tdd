...
public class PalindromoTest {
	...
	@Test
	public void testaVerificadorDePalavraPalindroma() {
		
		String palavraPalindroma = "deleveled";
		String palavraNaoPalindroma = "palavra";
		
		Palindromo palidromo = new Palindromo();
		
		Assert.assertTrue(palidromo.ehPalindromo(palavraPalindroma));
		Assert.assertFalse(palidromo.ehPalindromo(palavraNaoPalindroma));
